...
def run(_xmldoc,_element,
    ...
    ret = [
        ...
        (("dc:log_mu_estimate",{ "material": material_str}), numericunitsv(log_mu_estimate,"Unitless")),
        (("dc:log_mu_sd",{ "material": material_str}), numericunitsv(log_mu_sd,"Unitless")),
        ...
        (("dc:log_msqrtR_estimate",{"material": material_str}), numericunitsv(log_msqrtR_estimate,"ln_meters*-1.5")),
        (("dc:log_msqrtR_sd",{"material": material_str}), numericunitsv(log_msqrtR_sd,"ln_meters*-1.5")),
        ...
        (("dc:sigma_multiplicative_estimate",{ "material": material_str}), numericunitsv(sigma_multiplicative_estimate,"Unitless")),
        (("dc:sigma_multiplicative_sd",{ "material": material_str}), numericunitsv(sigma_multiplicative_sd,"Unitless")),
        (("dc:log_sigma_multiplicative_estimate",{ "material": material_str}), numericunitsv(log_sigma_multiplicative_estimate,"Unitless")),
        (("dc:log_sigma_multiplicative_sd",{ "material": material_str}), numericunitsv(log_sigma_multiplicative_sd,"Unitless")),
