/* dqagse_fparams.f -- translated by f2c (version 20190311).
...
/* Subroutine */ int dqagse_(D_fp f, doublereal *fp1, doublereal *fp2, 
	doublereal *fp3, doublereal *fp4, doublereal *a, doublereal *b, 
	...
	integer *iord, integer *last)
{
    ...
    integer numrl2;
    doublereal defabs, epmach, erlarg, abseps, correc, errbnd, resabs;
    integer jupbnd;
...
/*            fp1    - double parameter #1 for f */
/*            fp2    - double parameter #2 for f */
/*            fp3    - double parameter #3 for f */
/*            fp4    - double parameter #4 for f */
/*            a      - double precision */
...
/*           ----------------------------------- */
    ...
    oflow = d1mach_(&c__2);
    ierro = 0;
    dqk21_((D_fp)f, fp1, fp2, fp3, fp4, a, b, result, abserr, &defabs, &
	    resabs);
...
/*           estimate. */
	...
	b2 = blist[maxerr];
	erlast = errmax;
	dqk21_((D_fp)f, fp1, fp2, fp3, fp4, &a1, &b1, &area1, &error1, &
		resabs, &defab1);
	dqk21_((D_fp)f, fp1, fp2, fp3, fp4, &a2, &b2, &area2, &error2, &
		resabs, &defab2);
...
/* Subroutine */ int dqagie_(D_fp f, doublereal *fp1, doublereal *fp2, 
	doublereal *fp3, doublereal *fp4, doublereal *bound, integer *inf, 
	doublereal *epsabs, doublereal *epsrel, integer *limit, doublereal *
	result, doublereal *abserr, integer *neval, integer *ier, doublereal *
	alist__, doublereal *blist, doublereal *rlist, doublereal *elist, 
	integer *iord, integer *last)
...
/*           i2 = integral of f over (0,+infinity). */
    ...
    dqk15i_((D_fp)f, fp1, fp2, fp3, fp4, &boun, inf, &c_b26, &c_b27, result, 
...
/*           bisect the subinterval with nrmax-th largest error estimate. */
	...
	b2 = blist[maxerr];
	erlast = errmax;
	dqk15i_((D_fp)f, fp1, fp2, fp3, fp4, &boun, inf, &a1, &b1, &area1, &
		error1, &resabs, &defab1);
	dqk15i_((D_fp)f, fp1, fp2, fp3, fp4, &boun, inf, &a2, &b2, &area2, &
		error2, &resabs, &defab2);
...
/* Subroutine */ int dqk15i_(D_fp f, doublereal *fp1, doublereal *fp2, 
	doublereal *fp3, doublereal *fp4, doublereal *boun, integer *inf, 
	...
	doublereal *resabs, doublereal *resasc)
{
    ...
    /* Local variables */
    integer j;
    doublereal fc, fv1[7], fv2[7], absc, dinf, resg, resk, fsum, absc1, absc2,
...
/* ***first executable statement  dqk15i */
    ...
    fval1 = (*f)(&tabsc1, fp1, fp2, fp3, fp4);
    if (*inf == 2) {
	d__1 = -tabsc1;
	fval1 += (*f)(&d__1, fp1, fp2, fp3, fp4);
    }
...
/*           the integral, and estimate the error. */
    ...
    *resabs = abs(resk);
	...
	fval1 = (*f)(&tabsc1, fp1, fp2, fp3, fp4);
	fval2 = (*f)(&tabsc2, fp1, fp2, fp3, fp4);
	if (*inf == 2) {
	    d__1 = -tabsc1;
	    fval1 += (*f)(&d__1, fp1, fp2, fp3, fp4);
	}
...
/* Subroutine */ int dqk21_(D_fp f, doublereal *fp1, doublereal *fp2, 
	doublereal *fp3, doublereal *fp4, doublereal *a, doublereal *b, 
